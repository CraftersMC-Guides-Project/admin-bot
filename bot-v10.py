...
async def updatepet(ctx, pet_identifier: str = None, price_type: str = None, rarity: str = None, price: float = None):
    """
...
async def updateminion(ctx, minion_id: int = None, tier: str = None, price_type: str = None, price: int = None):
